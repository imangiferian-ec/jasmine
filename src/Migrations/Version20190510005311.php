 ...
 */
final class Version20190510005311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE roles (id INT AUTO_INCREMENT NOT NULL, landing_page_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, is_active_role TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_B63E2EC7DF122DC5 (landing_page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE permission_lists (id INT AUTO_INCREMENT NOT NULL, module_id INT NOT NULL, function_name VARCHAR(100) NOT NULL, route VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, permitted_roles JSON NOT NULL, position SMALLINT NOT NULL, is_active TINYINT(1) DEFAULT \'1\' NOT NULL, is_side_menu TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_DEA1F2D6AFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE academic_years (id INT AUTO_INCREMENT NOT NULL, ay_start_year VARCHAR(4) NOT NULL, ay_end_year VARCHAR(4) NOT NULL, is_active_ay TINYINT(1) DEFAULT \'1\' NOT NULL, is_accepting_examinee TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE academic_year_instances (id INT AUTO_INCREMENT NOT NULL, academic_year_id INT NOT NULL, semester_id INT NOT NULL, semester_start_date DATE NOT NULL, enrollment_start_date DATE NOT NULL, enrollment_end_date DATE NOT NULL, remarks LONGTEXT DEFAULT NULL, is_active_ayi TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_78FCDA4C54F3401 (academic_year_id), INDEX IDX_78FCDA44A798B6F (semester_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE faculty_loads (id INT AUTO_INCREMENT NOT NULL, employee_id INT NOT NULL, subject_offerring_id INT NOT NULL, is_grade_submitted TINYINT(1) DEFAULT \'0\' NOT NULL, grade_save_at DATETIME NOT NULL, grade_submitted_at DATETIME NOT NULL, grade_updated_at DATETIME NOT NULL, is_grade_finalized TINYINT(1) DEFAULT \'0\' NOT NULL, date_grade_finalized DATE NOT NULL, grade_finalized_at DATETIME NOT NULL, is_added_subject TINYINT(1) DEFAULT \'0\' NOT NULL, date_subject_added DATE NOT NULL, INDEX IDX_63A94DA88C03F15C (employee_id), INDEX IDX_63A94DA8CC6E2771 (subject_offerring_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE curriculums (id INT AUTO_INCREMENT NOT NULL, academic_year_id INT NOT NULL, course_id INT NOT NULL, curriculum_code VARCHAR(30) NOT NULL, title LONGTEXT NOT NULL, status VARCHAR(1) NOT NULL, is_finalized TINYINT(1) NOT NULL, is_active_curriculum TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_1918BEA6C54F3401 (academic_year_id), INDEX IDX_1918BEA6591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE enrollment_details (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, course_id INT NOT NULL, section_id INT NOT NULL, academic_year_id INT NOT NULL, semester_id INT NOT NULL, enrolling_officer_id INT NOT NULL, student_picture LONGTEXT DEFAULT NULL, date_enrolled DATETIME NOT NULL, remarks LONGTEXT NOT NULL, is_balik_aral TINYINT(1) NOT NULL, is_transferee TINYINT(1) NOT NULL, is_cross_enrollee TINYINT(1) NOT NULL, is_fully_paid TINYINT(1) NOT NULL, is_medically_cleared TINYINT(1) NOT NULL, is_finalalized TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_BCA960DFCB944F1A (student_id), INDEX IDX_BCA960DF591CC992 (course_id), INDEX IDX_BCA960DFD823E37A (section_id), INDEX IDX_BCA960DFC54F3401 (academic_year_id), INDEX IDX_BCA960DF4A798B6F (semester_id), INDEX IDX_BCA960DFF570E2BA (enrolling_officer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subjects (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, course_id INT DEFAULT NULL, subject_code VARCHAR(30) NOT NULL, subject_title LONGTEXT NOT NULL, description LONGTEXT NOT NULL, units SMALLINT NOT NULL, lecture_hour DOUBLE PRECISION NOT NULL, lab_hour DOUBLE PRECISION DEFAULT NULL, INDEX IDX_AB259917AE80F5DF (department_id), INDEX IDX_AB259917591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE roles ADD CONSTRAINT FK_B63E2EC7DF122DC5 FOREIGN KEY (landing_page_id) REFERENCES permission_lists (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE roles DROP FOREIGN KEY FK_B63E2EC7DF122DC5');
